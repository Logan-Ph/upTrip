				  ...
				  <dialog id="my_modal_3" className="modal">
					<div className="modal-box">
					  ...
					  <p className="py-4">
						...
						using Uptrip, you agree to abide by these terms. Please
						read them carefully. <br />
						<br />
						<b>Use of Services: </b> Uptrip provides a platform for
						users to compare prices of hotels, flights, tours, and
						experiences from various travel platforms. You may use
						our services for personal, non-commercial purposes only.
						<br />
						<br />
						<b>User Accounts:</b> To access certain features of
						Uptrip, you may need to create a user account. You are
						...
						<br />
						<b>Intellectual Property:</b> All intellectual property
						rights related to Uptrip, including trademarks, logos,
						and content, are owned by Uptrip or its licensors. You
						may not use our intellectual property without prior
						written consent. <br />
						<br />
						<b>Prohibited Conduct:</b> You agree not to engage in
						any conduct that violates these terms or infringes upon
						the rights of others. Prohibited conduct includes but is
						not limited to unauthorized access to our systems,
						interference with our services, and misuse of user data.
						<br />
						<br />
						<b>Privacy:</b> We respect your privacy and are
						committed to protecting your personal information.
						Please review our Privacy Policy to understand how we
						collect, use, and disclose your data. <br />
						<br />
						<b>Changes to Terms:</b> We reserve the right to update
						or modify these terms and conditions at any time. Any
						changes will be effective immediately upon posting to
						our website. It is your responsibility to review these
						terms periodically. <br />
