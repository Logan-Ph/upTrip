            ...
            <div className="p-6 md:col-span-2 my-auto">
              {loading ? (
                ...
                <div>
                  ...
                  <form name="SignUpForm" className="mt-5 space-y-3">
                    ...
                    <div class="flex items-start">
                      ...
                      <dialog id="my_modal_3" className="modal">
                        <div className="modal-box">
                          ...
                          <p className="py-4">
                            Welcome to Uptrip! These terms and conditions govern
                            your use of our website and services. By accessing
                            or using Uptrip, you agree to abide by these terms.
                            Please read them carefully. <br />
                            <br />
                            <b>Use of Services: </b> Uptrip provides a platform
                            for users to compare prices of hotels, flights,
                            tours, and experiences from various travel
                            platforms. You may use our services for personal,
                            non-commercial purposes only.
                            <br />
                            <br />
                            <b>User Accounts:</b> To access certain features of
                            Uptrip, you may need to create a user account. You
                            ...
                            <br />
                            <b>Content: </b>The content provided on Uptrip,
                            including but not limited to hotel listings, flight
                            details, and tour information, is for informational
                            purposes only. We do not endorse or guarantee the
                            accuracy of any third-party content. <br />
                            <br />
                            <b>Intellectual Property:</b> All intellectual
                            property rights related to Uptrip, including
                            trademarks, logos, and content, are owned by Uptrip
                            or its licensors. You may not use our intellectual
                            property without prior written consent. <br />
                            <br />
                            <b>Prohibited Conduct:</b> You agree not to engage
                            in any conduct that violates these terms or
                            infringes upon the rights of others. Prohibited
                            conduct includes but is not limited to unauthorized
                            access to our systems, interference with our
                            services, and misuse of user data.
                            <br />
                            <br />
                            <b>Privacy:</b> We respect your privacy and are
                            committed to protecting your personal information.
                            Please review our Privacy Policy to understand how
                            we collect, use, and disclose your data. <br />
                            <br />
                            <b>Changes to Terms:</b> We reserve the right to
                            update or modify these terms and conditions at any
                            time. Any changes will be effective immediately upon
                            posting to our website. It is your responsibility to
                            review these terms periodically. <br />
                            <br /> If you have any questions or concerns about
                            these terms and conditions, please contact us at{" "}
                            <i>levelupyourtrip@gmail.com</i>
                          </p>
                        </div>
                      </dialog>
                    </div>
