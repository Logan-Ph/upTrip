...
export default function Header() {
  ...
  useEffect(() => {
    const datepickerEl1 = document.getElementById("datepickerId1");
    const datepickerEl2 = document.getElementById("datepickerId2");
        const datepickerEl3 = document.getElementById("datepickerId3");

            const datepickerEl4 = document.getElementById("datepickerId4");

    // console.log(datepickerEl);
    new Datepicker(datepickerEl1,{});
    new Datepicker(datepickerEl2, {});
    new Datepicker(datepickerEl3, {});
    new Datepicker(datepickerEl4, {});
  }, []);
    ...
    <>
      <div class="bg-loginbackground bg-cover bg-center">
        ...
        <div class="w-11/12 container mx-auto mt-20 md:mt32 mb-20">
          <p class="text-white text-lg mb-3 font-thin">LEVEL UP YOUR TRIP</p>
