...
export default function DetailPageGallery(){
    ...
    return(
        ...
        <div className="relative">
            ...
            <div onClick={handleOpen} className="absolute bottom-0 right-0 py-2 px-6 bg-white bg-opacity-70 text-black shadow-sm cursor-pointer flex items-center">
            ...
            <Modal
                ...
                >
                <Box className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] bg-white border-2 border-black shadow-2xl p-4 overflow-auto">
