        ...
        <>
            ...
            <div className="flex justify-center my-4">
                ...
                <div className="flex items-center my-2 pr-4 md:pr-0">
                    <div className="border border-[#8DD3BB] w-[50px] h-[50px] flex items-center justify-between rounded-md cursor-pointer py-2" onClick={toggleDrawer}>
                        <svg className="w-[30px] h-[30px] mx-auto hover:transition ease-in-out delay-150:-translate-y-1 hover:scale-110 duration-300 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            fill="">
