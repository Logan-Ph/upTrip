...
{
    return<>
        <div className="border border-transparent rounded-md shadow-md bg-white transition ease-in-out delay-150 hover:translate-x-0.5 hover:scale-100 duration-300">
