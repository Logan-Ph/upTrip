                ...
                <div class="card flex-col md:flex-row card-side rounded-lg bg-white shadow-xl">
                    <figure class="rounded-t-lg rounded-b-none md:rounded-tr-none md:rounded-l-lg h-full items-start">
                        <img
                            src={item.imgSrc}
                            alt="Experience Pic"
                            className="w-full h-[150px] md:w-[250px] md:h-full object-cover"
                        />
                    </figure>
                ...
                <div class="card flex-col md:flex-row card-side rounded-lg bg-white shadow-xl">
                    ...
                    <div class="card-body flex-1 px-5 pt-3 pb-7 md:p-7 justify-between">
                        <div className="flex space-x-6">
                            <div className="flex justify-between flex-col md:flex-row flex-1">
                                ...
                                <div className="text-gray-500 font-semibold">
                                    {item.flightNo.length === 1
                                        ? "non-stop"
                                        : item.flightNo.length + 1 + "stop(s)"}
                                </div>
                                <div className="flex flex-col">
                                    <div className="font-semibold">
                                        {item.duration}
