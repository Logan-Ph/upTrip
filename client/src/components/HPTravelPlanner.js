            ...
            <section className="mx-auto max-w-7xl px-6 py-6 mt-8">
                <div>
                    ...
                    <p className="text-lg font-light">
                        Effortlessly plan your dream vacation with our
            ...
            <div className="bg-[#8DD3BB] border border-transparent rounded-xl p-8">
                <div className="flex flex-col h-full content-center">
                    ...
                    <p className="text-md font-light py-8">
                        Stay organized by easily keeping track of your bookings
                        and activities in one place, and tailor your trip to
                        suit your preferences and interests with customizable
                        itineraries. Receive personalized recommendations based
                        on your travel preferences and interests, and
            ...
            <div className="bg-homepagegairport bg-cover bg-center w-full md:h-[400px] rounded-xl border-4 ">
                <div className="flex flex-col md:flex-row w-full h-full mx-auto p-4 backdrop-opacity-15 backdrop-invert rounded-lg shadow-md">
                    <div className="p-4 flex flex-col items-center justify-end mx-auto">
                        <p className="font-extrabold text-5xl text-white py-2">
                            Flights
                        </p>
                        <p className="font-light text-md text-white py-2">
                            Search Flights & Place Hire to our most popular
                            destinations
                        </p>

                        <button
                            onClick={scrollToTop}
                            className="bg-[#8DD3BB] hover:bg-[#CDEAE1] text-black font-medium py-2 px-8 rounded transition ease-in-out delay-50 hover:translate-y-1 duration-100 capitalize text-md mt-2 flex items-center justify-center space-x-2"
                        >
                            <svg
                                className="w-4 h-4"
